  ...
  if (!session || !profile) {
    ...
    return (
      <div className="max-w-md mx-auto px-6 py-20 fade-up">
        ...
        <p className="text-slate-400 font-body text-sm mb-6">Patient records are restricted to clinical staff.</p>
    ...
    return (
      <div className="max-w-md mx-auto px-6 py-20 text-center fade-up">
        ...
        <p className="text-slate-400 font-body text-sm mt-2">
          Patient master records can only be accessed by doctors and administrators. This account has the role "{profile.role}".
        </p>
